...
CHAKRA.slider = function(){
  $.supersized({
    ...
    slides          :   [     // Slideshow Images 
                      {image : '/plugins/chakra/images/slider-images/image01.jpg', title : '<div class="slide-content"><h1>Yhteinen</h1><div class="hashtags"><a href="#">#KantaaottavaLuovuus</a><a href="#">#Kulttuurinmuutos</a><a href="#">#RakentavaKeskustelu</a></div></div>', thumb : '', url : ''}
...
CHAKRA.map = function(){
  if($('.map').length > 0)
  {
    ...
    $('.map').each(function(i,e){
      ...
      var image = '/plugins/chakra/images/marker.png';
